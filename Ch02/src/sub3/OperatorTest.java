...
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean rs2=var1 <var2;//var2가 작다
		boolean rs3=var1 >=var2;//var1이 크거나 같다.
		boolean rs4=var1 <=var2;//var2가 크거나 같다
		boolean rs5=var1 ==var2;//둘이 똑같다.
		boolean rs6=var1 !=var2;//둘이 다르다.
