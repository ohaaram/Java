...
interface A {
	...
	// 메서드는 람다식을 쓸거기때문에 하나만 존재해야한다. 두 개 이상이면 클래스로 구현해야함.
}
...
public class LambdaTest {
	public static void main(String[] args) {
		...
		/*
		 * B b4=(s)->{ System.out.println(s.length()); };
		 */
		// B b5=String::length;
